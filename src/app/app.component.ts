...
export class AppComponent implements OnInit
 {
  @ViewChild('appDiv', {static: true}) appDiv: ElementRef;
  ...
  crearTablero = () => {
    this.appDiv.nativeElement.innerHTML = `<div id="tablero"></div>`;
    let tabla = this.document.getElementById("tablero");
    for (let i = 0; i < 8; i++) {
      for (let e = 0; e < 8; e++) {
        let clase = "caja" + i + e;
        let casilla: Casilla = {
        ...
        let caja = this.document.createElement("div");
        caja.id = clase;
  ...
  cargarFichasATablero = () => {
      ...
      let c = this.document.getElementById(caja.clase);
      c.innerHTML = "";
